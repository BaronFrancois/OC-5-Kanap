...
// let varId = new URLSearchParams(window.location.search).get('_id');
// // Appel de la fonction searchProduct
// searchProduct();

// // Fonction pour rechercher un produit par son ID et charger les informations du produit
// async function searchProduct() {
// 	await fetch('http://localhost:3000/api/products/' + varId)
// 		.then((res) => res.json())
// 		.then((data) => loadCard(data)) // Charger les informations du produit avec la fonction loadCard
