...
// 	cardId : "cart",
//     load : function(){
// 		const sCart = localStorage.getItem(cardId);
// 		return JSON.parse(sCart);
// 	},
// 	push  : function(sArticle){
// 		const cart = Cart.load();
// 		cart.push(sArticle);
// 		Cart.save(cart);
// 	},
// 	save : function(sCart){
// 		localStorage.setItem(cardId, sCart);

// 	}
// }
// console.log(Cart)
// Cart.save(JSON.strigify(article));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 const Cart = {
 	cartId: "cart",
 	load: function () {
 	  const sCart = localStorage.getItem(this.cartId);
 	...
 	save: function (sCart) {
 	  localStorage.setItem(this.cartId, JSON.stringify(sCart));
 	},
   };
   ...
   function loadAndDisplayCart() {
 	...
 	console.log("%c%s%c cartItems: %o","color: green;","loadAndDisplayCart()","",cartItems)
 	displayCartItems(cartItems);
 	updateCartTotal(cartItems);
   }

   // Événement pour supprimer un élément du panier
   cartItemsElement.addEventListener("click", (event) => {
 	...
 	Cart.save(updatedCartItems);
 	loadAndDisplayCart();
   });

   // Événement pour mettre à jour la quantité d'un élément du panier
